...
APPEND_ONLY_TABLES = (
    "communications_emaildeliveryrecord",
    "communications_communicationevent",
)


def install_communications_append_only_guards(apps, schema_editor):
...
def uninstall_communications_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_communications_append_only_guards,
            uninstall_communications_append_only_guards,
        ),
    ]
