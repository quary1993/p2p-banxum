...
APPEND_ONLY_TABLES = ("fx_fxexternalsettlement",)


def install_external_settlement_append_only_guards(apps, schema_editor):
...
def uninstall_external_settlement_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ("fx", "0003_alter_fxevent_event_type_fxexternalsettlement_and_more"),
    ]

    operations = [
        migrations.RunPython(
            install_external_settlement_append_only_guards,
            uninstall_external_settlement_append_only_guards,
        ),
    ]
