...
def _create_primary_order_context(*, investor: Model, admin_user: Model) -> Model:
    ...
    loan = loan_model.objects.create(
        ...
        original_principal_minor=100_000_00,
        principal_minor=100_000_00,
        currency_id="CHF",
        interest_rate_bps=950,
        term_months=12,
        repayment_type="bullet_periodic_interest",
        loan_start_date=timezone.localdate() + dt.timedelta(days=17),
        funding_deadline=timezone.localdate() + dt.timedelta(days=17),
        first_payment_date=timezone.localdate() + dt.timedelta(days=48),
    ...
    installment_model.objects.create(
        ...
        due_date=timezone.localdate() + dt.timedelta(days=352),
        principal_minor=100_000_00,
