...
INSTALLED_APPS = [
    ...
    "backend.apps.originator_claims",
...
AUTH_ADMIN_LOGIN_CONFIRM_DAILY_LIMIT = env.int(
    "AUTH_ADMIN_LOGIN_CONFIRM_DAILY_LIMIT",
    default=100,
)
GARANTA_SUPERADMIN_EMAIL = env("GARANTA_SUPERADMIN_EMAIL", default="")
GARANTA_SUPERADMIN_PASSWORD_HASH = env("GARANTA_SUPERADMIN_PASSWORD_HASH", default="")
...
QA_DEV_MODE_MAX_ADVANCE_DAYS = env.int("QA_DEV_MODE_MAX_ADVANCE_DAYS", default=120)
...
TWILIO_EMAIL_API_KEY_SID = env("TWILIO_EMAIL_API_KEY_SID", default="")
TWILIO_EMAIL_API_KEY_SECRET = env("TWILIO_EMAIL_API_KEY_SECRET", default="")
TWILIO_EMAIL_FROM_EMAIL = env(
    "TWILIO_EMAIL_FROM_EMAIL",
    default="notifications@nxnarena.com",
)
TWILIO_EMAIL_FROM_NAME = env("TWILIO_EMAIL_FROM_NAME", default=PLATFORM_BRAND_NAME)
TWILIO_EMAIL_TIMEOUT_SECONDS = env.int("TWILIO_EMAIL_TIMEOUT_SECONDS", default=10)
