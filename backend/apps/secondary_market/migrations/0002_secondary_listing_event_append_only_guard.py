...
APPEND_ONLY_TABLES = ("secondary_market_secondarymarketlistingevent",)


def install_secondary_market_append_only_guards(apps, schema_editor):
...
def uninstall_secondary_market_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_secondary_market_append_only_guards,
            uninstall_secondary_market_append_only_guards,
        ),
    ]
