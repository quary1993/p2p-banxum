...
APPEND_ONLY_TABLES = (
    "ledger_bankoperation",
    "ledger_ledgerjournalentry",
    "ledger_ledgerposting",
    "ledger_reconciliationsnapshot",
)


def install_ledger_append_only_guards(apps, schema_editor):
...
def uninstall_ledger_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_ledger_append_only_guards,
            uninstall_ledger_append_only_guards,
        ),
    ]
