...
APPEND_ONLY_TABLES = ("marketplace_primary_primaryloanclose",)


def install_primary_close_append_only_guards(apps, schema_editor):
...
def uninstall_primary_close_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("marketplace_primary", "0003_alter_primaryinvestmentorder_status_and_more"),
    ]

    operations = [
        migrations.RunPython(
            install_primary_close_append_only_guards,
            uninstall_primary_close_append_only_guards,
        ),
    ]
