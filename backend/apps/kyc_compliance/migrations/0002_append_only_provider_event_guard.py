...
APPEND_ONLY_TABLE = "kyc_compliance_kycproviderevent"


def install_provider_event_append_only_guard(apps, schema_editor):
...
def uninstall_provider_event_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("kyc_compliance", "0001_initial"),
    ]

    operations = [
        migrations.RunPython(
            install_provider_event_append_only_guard,
            uninstall_provider_event_append_only_guard,
        ),
    ]
