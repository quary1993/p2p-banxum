...
class Command(BaseCommand):
    help = (
        "Import the Garanta/BANXUM project investment confirmation DOCX as the "
        "current primary-market investment document template."
    )
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        if imported.unresolved_placeholders and not options["allow_unresolved_placeholders"]:
            ...
            raise CommandError(
                "Investment confirmation still contains unresolved legal/commercial "
                f"placeholders: {unresolved}. Complete the DOCX or rerun with "
        ...
        try:
            version = create_document_template_version(
                CreateDocumentTemplateVersionCommand(
                    ...
                    name="Garanta Project Investment Confirmation",
                    description=(
                        "Per-primary-order project investment confirmation and claim "
                        "assignment agreement imported from the Garanta aligned final "
                        "draft DOCX."
                    ),
                    ...
                    metadata={
                        ...
                        "generation_context": "one_acceptance_per_primary_investment_order",
                    },
                    note="Imported project investment confirmation DOCX.",
                )
            )
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Imported project investment confirmation "
