...
APPEND_ONLY_TABLES = (
    "servicing_loanrisknote",
    "servicing_loanwriteoffevent",
)


def install_servicing_risk_append_only_guards(apps, schema_editor):
...
def uninstall_servicing_risk_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("servicing", "0005_loanrisknote_loanwriteoffevent"),
    ]

    operations = [
        migrations.RunPython(
            install_servicing_risk_append_only_guards,
            uninstall_servicing_risk_append_only_guards,
        ),
    ]
