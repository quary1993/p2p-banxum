...
APPEND_ONLY_TABLES = ("fx_fxexternalsettlementexchange",)


def install_external_settlement_exchange_append_only_guards(apps, schema_editor):
...
def uninstall_external_settlement_exchange_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ("fx", "0005_fxexternalsettlementexchange"),
    ]

    operations = [
        migrations.RunPython(
            install_external_settlement_exchange_append_only_guards,
            uninstall_external_settlement_exchange_append_only_guards,
        ),
    ]
