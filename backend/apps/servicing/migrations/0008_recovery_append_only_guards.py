...
APPEND_ONLY_TABLES = (
    "servicing_loanrecoveryevent",
    "servicing_investorrecoverydistributionline",
)


def install_servicing_recovery_append_only_guards(apps, schema_editor):
...
def uninstall_servicing_recovery_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("servicing", "0007_loanrecoveryevent_investorrecoverydistributionline_and_more"),
    ]

    operations = [
        migrations.RunPython(
            install_servicing_recovery_append_only_guards,
            uninstall_servicing_recovery_append_only_guards,
        ),
    ]
