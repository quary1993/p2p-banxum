...
APPEND_ONLY_TABLES = (
    "servicing_borrowerrepaymentevent",
    "servicing_investorrepaymentdistributionline",
)


def install_servicing_append_only_guards(apps, schema_editor):
...
def uninstall_servicing_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("servicing", "0003_remove_borrowerrepaymentevent_servicing_repayment_amounts_nonnegative_and_more"),
    ]

    operations = [
        migrations.RunPython(
            install_servicing_append_only_guards,
            uninstall_servicing_append_only_guards,
        ),
    ]
