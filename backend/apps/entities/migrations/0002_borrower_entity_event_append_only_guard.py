...
APPEND_ONLY_TABLE = "entities_borrowerentityevent"


def install_borrower_entity_event_append_only_guard(apps, schema_editor):
...
def uninstall_borrower_entity_event_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_borrower_entity_event_append_only_guard,
            uninstall_borrower_entity_event_append_only_guard,
        ),
    ]
