...
APPEND_ONLY_TABLES = ("secondary_market_secondarymarketpurchase",)


def install_secondary_market_purchase_append_only_guards(apps, schema_editor):
...
def uninstall_secondary_market_purchase_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("secondary_market", "0003_secondarymarketlisting_sold_at_and_more"),
    ]

    operations = [
        migrations.RunPython(
            install_secondary_market_purchase_append_only_guards,
            uninstall_secondary_market_purchase_append_only_guards,
        ),
    ]
