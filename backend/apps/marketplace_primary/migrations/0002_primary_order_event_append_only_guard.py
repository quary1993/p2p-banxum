...
APPEND_ONLY_TABLES = ("marketplace_primary_primaryinvestmentorderevent",)


def install_primary_order_event_append_only_guard(apps, schema_editor):
...
def uninstall_primary_order_event_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("marketplace_primary", "0001_initial"),
    ]

    operations = [
        migrations.RunPython(
            install_primary_order_event_append_only_guard,
            uninstall_primary_order_event_append_only_guard,
        ),
    ]
