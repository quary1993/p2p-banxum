...
const SCREENS = [
  ...
  },
  {
    ...
    focus: 'Superadmin-only governance: manage versioned legal/document TEMPLATES (create a new version, publish the current one), create ADMIN users (only an active superadmin can; admins differ from investors), browse the user directory, and change account access. Stress least-privilege.',
  },
]
