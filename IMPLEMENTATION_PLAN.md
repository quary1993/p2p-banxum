...
- Settle immediately in-platform:
  - recompute purchase-date accrued interest, buyer total, seller net, and maker/taker fees from the current holding and loan state before any ledger posting.
  - debit buyer balance.
  - charge taker fee.
  - charge maker fee.
...
- Remaining: partial holding sale rejection through buyer/settlement paths once purchase accepts a transfer amount or attempts to split holdings.
- Remaining: buyer balance eligibility tests.
- Remaining: buyer non-standard risk acknowledgement tests.
- Remaining: concurrent purchase tests.
- Remaining: maker/taker fee ledger posting tests.
- Remaining: claim transfer and document generation tests.
