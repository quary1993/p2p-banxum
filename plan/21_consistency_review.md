...
12. Risk Monitoring, Collections, and Recoveries: consistent. Garanta owns offline collections; platform tracks status, notes, documents, recovery events, write-offs, investor updates, gross-to-net recovery details, third-party recovery costs, Garanta recovery fee decisions, waterfall allocations, lender allocations, and recovery rounding differences.
...
15. Answered for planning: sender domain and support email remain TBD and are tracked in ADMIN_TODO.
