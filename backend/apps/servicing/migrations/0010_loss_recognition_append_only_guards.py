...
APPEND_ONLY_TABLES = ("servicing_investorlossrecognitionline",)


def install_servicing_loss_recognition_append_only_guards(apps, schema_editor):
...
def uninstall_servicing_loss_recognition_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("servicing", "0009_investorlossrecognitionline"),
    ]

    operations = [
        migrations.RunPython(
            install_servicing_loss_recognition_append_only_guards,
            uninstall_servicing_loss_recognition_append_only_guards,
        ),
    ]
