...
- Currency-exchange ledger records must retain source-entry lineage for audit/regulatory review, and target-currency entries must inherit balance-ageing deadlines from the source entries consumed by the FX transaction rather than receiving fresh 60-day holding deadlines.
