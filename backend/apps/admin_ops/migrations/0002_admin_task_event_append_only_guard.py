...
APPEND_ONLY_TABLE = "admin_ops_admintaskevent"


def install_admin_task_event_append_only_guard(apps, schema_editor):
...
def uninstall_admin_task_event_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_admin_task_event_append_only_guard,
            uninstall_admin_task_event_append_only_guard,
        ),
    ]
