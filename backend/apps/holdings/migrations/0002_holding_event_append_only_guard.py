...
APPEND_ONLY_TABLES = ("holdings_investorloanholdingevent",)


def install_holding_append_only_guards(apps, schema_editor):
...
def uninstall_holding_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_holding_append_only_guards,
            uninstall_holding_append_only_guards,
        ),
    ]
