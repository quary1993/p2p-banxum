...
APPEND_ONLY_TABLES = ("servicing_loanwriteoffevent",)


def install_writeoff_append_only_guard(apps, schema_editor):
...
def uninstall_writeoff_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("servicing", "0011_loanwriteoffevent_unique_loan_write_off_event"),
    ]

    operations = [
        migrations.RunPython(
            install_writeoff_append_only_guard,
            uninstall_writeoff_append_only_guard,
        ),
    ]
