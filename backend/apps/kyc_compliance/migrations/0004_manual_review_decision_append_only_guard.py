...
APPEND_ONLY_TABLE = "kyc_compliance_kycmanualreviewdecision"


def install_manual_review_append_only_guard(apps, schema_editor):
...
def uninstall_manual_review_append_only_guard(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("kyc_compliance", "0003_kycmanualreviewdecision"),
    ]

    operations = [
        migrations.RunPython(
            install_manual_review_append_only_guard,
            uninstall_manual_review_append_only_guard,
        ),
    ]
