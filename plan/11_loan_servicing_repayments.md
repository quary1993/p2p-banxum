...
Any borrower payment, prepayment, imported schedule change, or explicit hold before activation invalidates the agreed funding basis and blocks activation. Operations must cancel and refund the round; it must not silently recalculate investor rights. Routine off-platform KYB expiry does not block deterministic close or activation, but an explicit adverse status or compliance hold does.
