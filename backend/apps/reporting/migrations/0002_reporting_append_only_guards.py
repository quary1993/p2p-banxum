...
APPEND_ONLY_TABLES = (
    "reporting_reportrun",
    "reporting_reportevent",
)


def install_reporting_append_only_guards(apps, schema_editor):
...
def uninstall_reporting_append_only_guards(apps, schema_editor):
    vendor = schema_editor.connection.vendor
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            install_reporting_append_only_guards,
            uninstall_reporting_append_only_guards,
        ),
    ]
