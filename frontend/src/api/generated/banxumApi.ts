...
export interface BorrowerEntity {
  ...
  business_classification_public: boolean;
  registered_address: string;
  registered_address_public: boolean;
...
export interface BorrowerRepaymentAdvancePreviewRequest {
  loan_id: string;
  /** @minimum 1 */
  amount_minor: number;
  borrower_repayment_bank_date: string;
}

export interface BorrowerRepaymentAdvancePreviewResponse {
  loan_id: string;
  currency: string;
  amount_minor: number;
  bank_date: string;
  interest_accrual_start_date: string;
  interest_accrual_end_date: string;
  accrued_interest_days: number;
  scheduled_interest_due_minor: number;
  accrued_interest_minor: number;
  interest_applied_minor: number;
  principal_applied_minor: number;
  outstanding_principal_before_minor: number;
...
export interface FxExchange {
  ...
  readonly effective_net_rate: string;
...
export interface FxQuotePreview {
  source_currency: string;
  target_currency: string;
  source_amount_minor: number;
  provider: string;
 ...
 * @nullable
 */
export type HoldingOpenSecondaryListingProperty = HoldingOpenSecondaryListing | null;
...
export interface Holding {
  ...
  /** @nullable */
  open_secondary_listing: HoldingOpenSecondaryListingProperty;
}

export interface HoldingOpenSecondaryListing {
  id: string;
  status: string;
  publication_type: string;
  price_bps: number;
...
export interface Loan {
  ...
  original_principal_minor: number;
  /** @nullable */
  original_interest_rate_bps: number | null;
  /** @nullable */
  original_term_months: number | null;
  /** @nullable */
  readonly original_repayment_type: string | null;
  /** @nullable */
  original_interest_only_months: number | null;
  /** @nullable */
  original_loan_start_date: string | null;
  principal_minor: number;
  currency: string;
...
export interface LoanRecoveryPaymentRecordRequest {
  ...
  recovery_fee_bps?: number;
  /** @minimum 0 */
  contractual_interest_due_minor?: number;
  /** @minimum 0 */
  default_interest_due_minor?: number;
  /** @minimum 0 */
...
export interface MarketplaceLoanDetail {
  ...
  original_term_months: number | null;
  /** @nullable */
  original_repayment_type: string | null;
  /** @nullable */
  original_interest_only_months: number | null;
  /** @nullable */
  original_loan_start_date: string | null;
...
export interface OriginalLoanScheduleRow {
  installment_number: number;
  due_date: string;
  principal_minor: number;
  interest_minor: number;
...
export interface OriginatorAdminLoanDetailResponse {
  ...
  retained_principal_minor: number;
  sellable_principal_minor: number;
  interest_rate_bps: number;
...
export interface PortfolioHoldingInstallment {
...
export type PrimaryLoanExpiryScanResponseFailuresItem = {[key: string]: unknown};
...
export interface PrimaryLoanExpiryScanResponse {
  ...
  closed_count?: number;
  closes?: PrimaryLoanClose[];
  failed_count?: number;
  failures?: PrimaryLoanExpiryScanResponseFailuresItem[];
  skipped_count: number;
  cancellations: PrimaryLoanCancellation[];
  skipped: PrimaryLoanExpiryScanResponseSkippedItem[];
}

export interface PrimaryOrderBatchItem {
  loan_id: string;
  /** @minimum 1 */
  amount_minor: number;
  /** @nullable */
...
export interface PrimaryOrderBatchOriginatorPurchaseResponse {
  purchase_id: string;
  quote_id: string;
  loan_id: string;
  holding_id: string;
...
export interface PrimaryOrderBatchRequest {
  items: PrimaryOrderBatchItem[];
  document_acceptance_id: string;
  /** @maxLength 128 */
  idempotency_key: string;
  sensitive_action_code_id: string;
...
export type PrimaryOrderBatchResponseCurrencyTotalsItem = {[key: string]: unknown};

export interface PrimaryOrderBatchResponse {
  batch_id: string;
  /** @nullable */
  currency: string | null;
  currency_totals: PrimaryOrderBatchResponseCurrencyTotalsItem[];
  orders: PrimaryInvestmentOrder[];
  order_count: number;
  originator_purchases: PrimaryOrderBatchOriginatorPurchaseResponse[];
  originator_purchase_count: number;
  /** @nullable */
...
export interface PublishLoanRequest {
  pre_publication_paid_installment_numbers?: number[];
  note?: string;
}
...
export interface SecondaryMarketActivityEntryPortal {
  id: string;
  action: string;
  event_type: string;
  listing_id: string;
...
export interface SecondaryMarketActivityPortal {
  ...
  entries: SecondaryMarketActivityEntryPortal[];
}
 ...
 * @nullable
 */
export type SecondaryMarketBuyerListingDetailLatestPublicNote = SecondaryMarketLatestPublicNote | null;

export interface SecondaryMarketBuyerListingDetail {
  id: string;
  loan_id: string;
  loan_title: string;
  product_type: string;
  ...
  /** @nullable */
  latest_public_note: SecondaryMarketBuyerListingDetailLatestPublicNote;
}

export interface SecondaryMarketInvestmentInstallment {
  loan_installment_id: string;
  schedule_version: number;
  installment_number: number;
  due_date: string;
...
export interface SecondaryMarketListingEditRequest {
  /**
   * @minimum 1
   * @maximum 1000000
   */
 ...
 * @nullable
 */
export type SmartInvestResponseRule = SmartInvestRule | null;

export interface SmartInvestResponse {
  /** @nullable */
  rule: SmartInvestResponseRule;
  match_count: number;
  open_opportunity_count: number;
  matches: SmartInvestOpportunity[];
}

export interface SmartInvestRule {
  id: string;
  is_active: boolean;
  revision: number;
  /** @nullable */
...
export interface SmartInvestRuleSaveRequest {
  /**
   * @minimum 0
   * @maximum 100000
   * @nullable
...
export type V1FxQuotePreviewRetrieveParams = {
/**
 * @minimum 1
 */
source_amount_minor: number;
...
export const V1LoansAdminLoansListStatus = {
  draft: 'draft',
  published: 'published',
  funding_close_failed: 'funding_close_failed',
  funded: 'funded',
  active: 'active',
  late: 'late',
  defaulted: 'defaulted',
...
export const v1FxQuotePreviewRetrieve = (
    params: V1FxQuotePreviewRetrieveParams,
 signal?: AbortSignal
) => {


      return httpClient<FxQuotePreview>(
      {url: `/api/v1/fx/quote-preview/`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getV1FxQuotePreviewRetrieveQueryKey = (params?: V1FxQuotePreviewRetrieveParams,) => {
    return [
    `/api/v1/fx/quote-preview/`, ...(params ? [params]: [])
    ] as const;
    }


export const getV1FxQuotePreviewRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError = unknown>(params: V1FxQuotePreviewRetrieveParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getV1FxQuotePreviewRetrieveQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>> = ({ signal }) => v1FxQuotePreviewRetrieve(params, signal);





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type V1FxQuotePreviewRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>>
export type V1FxQuotePreviewRetrieveQueryError = unknown


export function useV1FxQuotePreviewRetrieve<TData = Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError = unknown>(
 params: V1FxQuotePreviewRetrieveParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>,
          TError,
          Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>
        > , 'initialData'
      >, }
...
export function useV1FxQuotePreviewRetrieve<TData = Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError = unknown>(
 params: V1FxQuotePreviewRetrieveParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useV1FxQuotePreviewRetrieve<TData = Awaited<ReturnType<typeof v1FxQuotePreviewRetrieve>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getV1FxQuotePreviewRetrieveQueryOptions(params,options)
...
export const v1InvestorSmartInvestRetrieve = (

 signal?: AbortSignal
) => {


      return httpClient<SmartInvestResponse>(
      {url: `/api/v1/investor/smart-invest/`, method: 'GET', signal
    },
      );
    }
...
export const getV1InvestorSmartInvestRetrieveQueryKey = () => {
    return [
...
export const getV1InvestorSmartInvestRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getV1InvestorSmartInvestRetrieveQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>> = ({ signal }) => v1InvestorSmartInvestRetrieve(signal);





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type V1InvestorSmartInvestRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>>
export type V1InvestorSmartInvestRetrieveQueryError = unknown


export function useV1InvestorSmartInvestRetrieve<TData = Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>,
          TError,
          Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>
        > , 'initialData'
      >, }
...
export function useV1InvestorSmartInvestRetrieve<TData = Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useV1InvestorSmartInvestRetrieve<TData = Awaited<ReturnType<typeof v1InvestorSmartInvestRetrieve>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getV1InvestorSmartInvestRetrieveQueryOptions(options)
...
export const v1InvestorSmartInvestUpdate = (
    smartInvestRuleSaveRequest: SmartInvestRuleSaveRequest,
 ) => {


      return httpClient<SmartInvestResponse>(
      {url: `/api/v1/investor/smart-invest/`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
      data: smartInvestRuleSaveRequest
    },
      );
    }
...
export const getV1InvestorSmartInvestUpdateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>, TError,{data: SmartInvestRuleSaveRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>, TError,{data: SmartInvestRuleSaveRequest}, TContext> => {

const mutationKey = ['v1InvestorSmartInvestUpdate'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>, {data: SmartInvestRuleSaveRequest}> = (props) => {
          const {data} = props ?? {};

          return  v1InvestorSmartInvestUpdate(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type V1InvestorSmartInvestUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>>
    export type V1InvestorSmartInvestUpdateMutationBody = SmartInvestRuleSaveRequest
    export type V1InvestorSmartInvestUpdateMutationError = unknown

    export const useV1InvestorSmartInvestUpdate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>, TError,{data: SmartInvestRuleSaveRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof v1InvestorSmartInvestUpdate>>,
        TError,
        {data: SmartInvestRuleSaveRequest},
        TContext
      > => {

      const mutationOptions = getV1InvestorSmartInvestUpdateMutationOptions(options);

      return useMutation(mutationOptions, queryClient);
    }

export const v1InvestorSmartInvestDeactivateCreate = (
 ...
 signal?: AbortSignal
      ...
      return httpClient<SmartInvestResponse>(
      {url: `/api/v1/investor/smart-invest/deactivate/`, method: 'POST', signal
    },
      );
    }
...
export const getV1InvestorSmartInvestDeactivateCreateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>, TError,void, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>, TError,void, TContext> => {

const mutationKey = ['v1InvestorSmartInvestDeactivateCreate'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>, void> = () => {


          return  v1InvestorSmartInvestDeactivateCreate()
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type V1InvestorSmartInvestDeactivateCreateMutationResult = NonNullable<Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>>

    export type V1InvestorSmartInvestDeactivateCreateMutationError = unknown

    export const useV1InvestorSmartInvestDeactivateCreate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>, TError,void, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof v1InvestorSmartInvestDeactivateCreate>>,
        TError,
        void,
        TContext
      > => {

      const mutationOptions = getV1InvestorSmartInvestDeactivateCreateMutationOptions(options);
...
export const v1LoansAdminLoansOriginalScheduleList = (
    loanId: string,
 signal?: AbortSignal
) => {


      return httpClient<OriginalLoanScheduleRow[]>(
      {url: `/api/v1/loans/admin/loans/${loanId}/original-schedule/`, method: 'GET', signal
    },
      );
    }
...
export const getV1LoansAdminLoansOriginalScheduleListQueryKey = (loanId?: string,) => {
    return [
    `/api/v1/loans/admin/loans/${loanId}/original-schedule/`
    ] as const;
    }


export const getV1LoansAdminLoansOriginalScheduleListQueryOptions = <TData = Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError = unknown>(loanId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getV1LoansAdminLoansOriginalScheduleListQueryKey(loanId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>> = ({ signal }) => v1LoansAdminLoansOriginalScheduleList(loanId, signal);





   return  { queryKey, queryFn, enabled: !!(loanId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type V1LoansAdminLoansOriginalScheduleListQueryResult = NonNullable<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>>
export type V1LoansAdminLoansOriginalScheduleListQueryError = unknown


export function useV1LoansAdminLoansOriginalScheduleList<TData = Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError = unknown>(
 loanId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>,
          TError,
          Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>
        > , 'initialData'
      >, }
...
export function useV1LoansAdminLoansOriginalScheduleList<TData = Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError = unknown>(
 loanId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useV1LoansAdminLoansOriginalScheduleList<TData = Awaited<ReturnType<typeof v1LoansAdminLoansOriginalScheduleList>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getV1LoansAdminLoansOriginalScheduleListQueryOptions(loanId,options)
...
export const marketplacePrimaryOrdersBatchCreate = (
    primaryOrderBatchRequest: PrimaryOrderBatchRequest,
 signal?: AbortSignal
) => {


      return httpClient<PrimaryOrderBatchResponse>(
      {url: `/api/v1/marketplace/primary/orders/batch/`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: primaryOrderBatchRequest, signal
    },
      );
    }
...
export const getMarketplacePrimaryOrdersBatchCreateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>, TError,{data: PrimaryOrderBatchRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>, TError,{data: PrimaryOrderBatchRequest}, TContext> => {

const mutationKey = ['marketplacePrimaryOrdersBatchCreate'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>, {data: PrimaryOrderBatchRequest}> = (props) => {
          const {data} = props ?? {};

          return  marketplacePrimaryOrdersBatchCreate(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type MarketplacePrimaryOrdersBatchCreateMutationResult = NonNullable<Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>>
    export type MarketplacePrimaryOrdersBatchCreateMutationBody = PrimaryOrderBatchRequest
    export type MarketplacePrimaryOrdersBatchCreateMutationError = unknown

    export const useMarketplacePrimaryOrdersBatchCreate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>, TError,{data: PrimaryOrderBatchRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof marketplacePrimaryOrdersBatchCreate>>,
        TError,
        {data: PrimaryOrderBatchRequest},
        TContext
      > => {

      const mutationOptions = getMarketplacePrimaryOrdersBatchCreateMutationOptions(options);

      return useMutation(mutationOptions, queryClient);
    }

export const v1MarketplaceSecondaryAdminListingsList = (
    params?: V1MarketplaceSecondaryAdminListingsListParams,
 signal?: AbortSignal
) => {


      return httpClient<AdminSecondaryMarketListingRow[]>(
      {url: `/api/v1/marketplace/secondary/admin/listings/`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getV1MarketplaceSecondaryAdminListingsListQueryKey = (params?: V1MarketplaceSecondaryAdminListingsListParams,) => {
    return [
    `/api/v1/marketplace/secondary/admin/listings/`, ...(params ? [params]: [])
    ] as const;
    }


export const getV1MarketplaceSecondaryAdminListingsListQueryOptions = <TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError = unknown>(params?: V1MarketplaceSecondaryAdminListingsListParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getV1MarketplaceSecondaryAdminListingsListQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>> = ({ signal }) => v1MarketplaceSecondaryAdminListingsList(params, signal);





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type V1MarketplaceSecondaryAdminListingsListQueryResult = NonNullable<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>>
export type V1MarketplaceSecondaryAdminListingsListQueryError = unknown


export function useV1MarketplaceSecondaryAdminListingsList<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError = unknown>(
 params: undefined |  V1MarketplaceSecondaryAdminListingsListParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>,
          TError,
          Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>
        > , 'initialData'
      >, }
...
export function useV1MarketplaceSecondaryAdminListingsList<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError = unknown>(
 params?: V1MarketplaceSecondaryAdminListingsListParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError, TData>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>,
          TError,
          Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>
...
export function useV1MarketplaceSecondaryAdminListingsList<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError = unknown>(
 params?: V1MarketplaceSecondaryAdminListingsListParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useV1MarketplaceSecondaryAdminListingsList<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryAdminListingsList>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getV1MarketplaceSecondaryAdminListingsListQueryOptions(params,options)
...
export const v1MarketplaceSecondaryListingsRetrieve = (
    listingId: string,
 signal?: AbortSignal
) => {


      return httpClient<SecondaryMarketBuyerListingDetail>(
      {url: `/api/v1/marketplace/secondary/listings/${listingId}/`, method: 'GET', signal
    },
      );
    }
...
export const getV1MarketplaceSecondaryListingsRetrieveQueryKey = (listingId?: string,) => {
    return [
    `/api/v1/marketplace/secondary/listings/${listingId}/`
    ] as const;
    }


export const getV1MarketplaceSecondaryListingsRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError = unknown>(listingId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getV1MarketplaceSecondaryListingsRetrieveQueryKey(listingId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>> = ({ signal }) => v1MarketplaceSecondaryListingsRetrieve(listingId, signal);





   return  { queryKey, queryFn, enabled: !!(listingId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type V1MarketplaceSecondaryListingsRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>>
export type V1MarketplaceSecondaryListingsRetrieveQueryError = unknown


export function useV1MarketplaceSecondaryListingsRetrieve<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError = unknown>(
 listingId: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>,
          TError,
          Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>
        > , 'initialData'
      >, }
...
export function useV1MarketplaceSecondaryListingsRetrieve<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError = unknown>(
 listingId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useV1MarketplaceSecondaryListingsRetrieve<TData = Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsRetrieve>>, TError = unknown>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getV1MarketplaceSecondaryListingsRetrieveQueryOptions(listingId,options)
...
export const v1MarketplaceSecondaryListingsEditCreate = (
    listingId: string,
    secondaryMarketListingEditRequest: SecondaryMarketListingEditRequest,
 signal?: AbortSignal
) => {


      return httpClient<SecondaryMarketListing>(
      {url: `/api/v1/marketplace/secondary/listings/${listingId}/edit/`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: secondaryMarketListingEditRequest, signal
    },
      );
    }
...
export const getV1MarketplaceSecondaryListingsEditCreateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>, TError,{listingId: string;data: SecondaryMarketListingEditRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>, TError,{listingId: string;data: SecondaryMarketListingEditRequest}, TContext> => {

const mutationKey = ['v1MarketplaceSecondaryListingsEditCreate'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>, {listingId: string;data: SecondaryMarketListingEditRequest}> = (props) => {
          const {listingId,data} = props ?? {};

          return  v1MarketplaceSecondaryListingsEditCreate(listingId,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type V1MarketplaceSecondaryListingsEditCreateMutationResult = NonNullable<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>>
    export type V1MarketplaceSecondaryListingsEditCreateMutationBody = SecondaryMarketListingEditRequest
    export type V1MarketplaceSecondaryListingsEditCreateMutationError = unknown

    export const useV1MarketplaceSecondaryListingsEditCreate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>, TError,{listingId: string;data: SecondaryMarketListingEditRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof v1MarketplaceSecondaryListingsEditCreate>>,
        TError,
        {listingId: string;data: SecondaryMarketListingEditRequest},
        TContext
      > => {

      const mutationOptions = getV1MarketplaceSecondaryListingsEditCreateMutationOptions(options);
...
export const v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate = (
    borrowerRepaymentAdvancePreviewRequest: BorrowerRepaymentAdvancePreviewRequest,
 signal?: AbortSignal
) => {


      return httpClient<BorrowerRepaymentAdvancePreviewResponse>(
      {url: `/api/v1/servicing/admin/borrower-repayments/advance-preview/`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: borrowerRepaymentAdvancePreviewRequest, signal
    },
      );
    }
...
export const getV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>, TError,{data: BorrowerRepaymentAdvancePreviewRequest}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>, TError,{data: BorrowerRepaymentAdvancePreviewRequest}, TContext> => {

const mutationKey = ['v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>, {data: BorrowerRepaymentAdvancePreviewRequest}> = (props) => {
          const {data} = props ?? {};

          return  v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type V1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMutationResult = NonNullable<Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>>
    export type V1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMutationBody = BorrowerRepaymentAdvancePreviewRequest
    export type V1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMutationError = unknown

    export const useV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>, TError,{data: BorrowerRepaymentAdvancePreviewRequest}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof v1ServicingAdminBorrowerRepaymentsAdvancePreviewCreate>>,
        TError,
        {data: BorrowerRepaymentAdvancePreviewRequest},
        TContext
      > => {

      const mutationOptions = getV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMutationOptions(options);
...
export const getV1EntitiesAdminBorrowersInvestorDisclosurePreviewRetrieveResponseMock = (overrideResponse: Partial< BorrowerInvestorDisclosure > = {}): BorrowerInvestorDisclosure => ({legal_name: faker.string.alpha({length: {min: 10, max: 20}}), year_founded: faker.number.int({min: undefined, max: undefined}), business_classification: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), registered_address: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), contact_info: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), country: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), financials_currency: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), assets_minor: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), liabilities_minor: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), revenue_last_year_minor: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), profit_last_year_minor: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), documents: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
...
export const getV1FxQuotePreviewRetrieveResponseMock = (overrideResponse: Partial< FxQuotePreview > = {}): FxQuotePreview => ({source_currency: faker.string.alpha({length: {min: 10, max: 20}}), target_currency: faker.string.alpha({length: {min: 10, max: 20}}), source_amount_minor: faker.number.int({min: undefined, max: undefined}), provider: faker.string.alpha({length: {min: 10, max: 20}}), rate: faker.helpers.fromRegExp('^-?\d{0,12}(?:\.\d{0,12})?$'), previous_day_average_rate: faker.helpers.arrayElement([faker.helpers.fromRegExp('^-?\d{0,12}(?:\.\d{0,12})?$'), null]), platform_fee_bps: faker.number.int({min: undefined, max: undefined}), gross_target_amount_minor: faker.number.int({min: undefined, max: undefined}), fee_minor: faker.number.int({min: undefined, max: undefined}), target_amount_minor: faker.number.int({min: undefined, max: undefined}), effective_net_rate: faker.helpers.fromRegExp('^-?\d{0,12}(?:\.\d{0,12})?$'), limit_chf_equivalent_minor: faker.number.int({min: undefined, max: undefined}), provider_rate_timestamp: `${faker.date.past().toISOString().split('.')[0]}Z`, sanity_metadata: {}, previewed_at: `${faker.date.past().toISOString().split('.')[0]}Z`, ...overrideResponse})

export const getV1FxQuotesCreateResponseMock = (overrideResponse: Partial< FxQuote > = {}): FxQuote => ({id: faker.string.uuid(), investor_user_id: faker.string.uuid(), source_currency: faker.string.alpha({length: {min: 10, max: 20}}), target_currency: faker.string.alpha({length: {min: 10, max: 20}}), source_amount_minor: faker.number.int({min: undefined, max: undefined}), provider: faker.string.alpha({length: {min: 10, max: 20}}), provider_quote_id: faker.string.alpha({length: {min: 10, max: 20}}), rate: faker.helpers.fromRegExp('^-?\d{0,12}(?:\.\d{0,12})?$'), previous_day_average_rate: faker.helpers.arrayElement([faker.helpers.fromRegExp('^-?\d{0,12}(?:\.\d{0,12})?$'), null]), platform_fee_bps: faker.number.int({min: undefined, max: undefined}), gross_target_amount_minor: faker.number.int({min: undefined, max: undefined}), fee_minor: faker.number.int({min: undefined, max: undefined}), target_amount_minor: faker.number.int({min: undefined, max: undefined}), effective_net_rate: faker.string.alpha({length: {min: 10, max: 20}}), limit_chf_equivalent_minor: faker.number.int({min: undefined, max: undefined}), issued_at: `${faker.date.past().toISOString().split('.')[0]}Z`, expires_at: `${faker.date.past().toISOString().split('.')[0]}Z`, provider_rate_timestamp: `${faker.date.past().toISOString().split('.')[0]}Z`, sanity_check_passed: faker.datatype.boolean(), sanity_metadata: {}, status: faker.string.alpha({length: {min: 10, max: 20}}), created_at: `${faker.date.past().toISOString().split('.')[0]}Z`, updated_at: `${faker.date.past().toISOString().split('.')[0]}Z`, ...overrideResponse})
...
export const getV1MarketplacePrimaryAdminLoansExpiryScanCreateResponseMock = (overrideResponse: Partial< PrimaryLoanExpiryScanResponse > = {}): PrimaryLoanExpiryScanResponse => ({as_of_date: faker.date.past().toISOString().split('T')[0], scanned_count: faker.number.int({min: undefined, max: undefined}), cancelled_count: faker.number.int({min: undefined, max: undefined}), closed_count: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), closes: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), loan_id: faker.string.uuid(), close_type: faker.string.alpha({length: {min: 10, max: 20}}), accepted_principal_minor: faker.number.int({min: undefined, max: undefined}), currency: faker.string.alpha({length: {min: 10, max: 20}}), allocated_order_count: faker.number.int({min: undefined, max: undefined}), closed_not_invested_order_count: faker.number.int({min: undefined, max: undefined}), borrower_success_fee_bps: faker.number.int({min: undefined, max: undefined}), borrower_success_fee_minor: faker.number.int({min: undefined, max: undefined}), borrower_disbursement_payable_minor: faker.number.int({min: undefined, max: undefined}), funding_close_journal_entry_id: faker.string.uuid(), created_by_admin_id: faker.string.uuid(), closed_at: `${faker.date.past().toISOString().split('.')[0]}Z`, reason: faker.string.alpha({length: {min: 10, max: 20}}), investor_message: faker.string.alpha({length: {min: 10, max: 20}}), created_at: `${faker.date.past().toISOString().split('.')[0]}Z`})), undefined]), failed_count: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), failures: faker.helpers.arrayElement([Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
        [faker.string.alphanumeric(5)]: {}
      })), undefined]), skipped_count: faker.number.int({min: undefined, max: undefined}), cancellations: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({id: faker.string.uuid(), loan_id: faker.string.uuid(), currency: faker.string.alpha({length: {min: 10, max: 20}}), released_order_count: faker.number.int({min: undefined, max: undefined}), closed_not_invested_order_count: faker.number.int({min: undefined, max: undefined}), released_principal_minor: faker.number.int({min: undefined, max: undefined}), created_by_admin_id: faker.string.uuid(), cancelled_at: `${faker.date.past().toISOString().split('.')[0]}Z`, reason: faker.string.alpha({length: {min: 10, max: 20}}), investor_message: faker.string.alpha({length: {min: 10, max: 20}}), created_at: `${faker.date.past().toISOString().split('.')[0]}Z`})), skipped: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
        [faker.string.alphanumeric(5)]: {}
      })), ...overrideResponse})
...
export const getV1MarketplacePrimaryLoansListResponseMock = (): MarketplaceLoanPreview[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({loan_id: faker.string.uuid(), product_type: faker.string.alpha({length: {min: 10, max: 20}}), investment_flow: faker.string.alpha({length: {min: 10, max: 20}}), title: faker.string.alpha({length: {min: 10, max: 20}}), purpose: faker.string.alpha({length: {min: 10, max: 20}}), collateral_type: faker.string.alpha({length: {min: 10, max: 20}}), interest_rate_bps: faker.number.int({min: undefined, max: undefined}), yield_bps: faker.number.int({min: undefined, max: undefined}), underlying_interest_rate_bps: faker.number.int({min: undefined, max: undefined}), term_months: faker.number.int({min: undefined, max: undefined}), remaining_term_days: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), risk_rating: faker.string.alpha({length: {min: 10, max: 20}}), funding_deadline: faker.helpers.arrayElement([faker.date.past().toISOString().split('T')[0], null]), maturity_date: faker.helpers.arrayElement([faker.date.past().toISOString().split('T')[0], null]), status: faker.string.alpha({length: {min: 10, max: 20}}), loan_status: faker.string.alpha({length: {min: 10, max: 20}}), opportunity_status: faker.string.alpha({length: {min: 10, max: 20}}), currency: faker.string.alpha({length: {min: 10, max: 20}}), principal_minor: faker.number.int({min: undefined, max: undefined}), committed_principal_minor: faker.number.int({min: undefined, max: undefined}), remaining_capacity_minor: faker.number.int({min: undefined, max: undefined}), fillable_amount_minor: faker.number.int({min: undefined, max: undefined}), minimum_investment_minor: faker.number.int({min: undefined, max: undefined}), ltv_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), is_refinancing: faker.datatype.boolean(), originator_id: faker.helpers.arrayElement([faker.string.uuid(), null]), originator_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), borrower_display_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), skin_in_the_game_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), minimum_subscription_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})))

export const getV1MarketplacePrimaryLoansRetrieveResponseMock = (overrideResponse: Partial< MarketplaceLoanDetail > = {}): MarketplaceLoanDetail => ({loan_id: faker.string.uuid(), product_type: faker.string.alpha({length: {min: 10, max: 20}}), investment_flow: faker.string.alpha({length: {min: 10, max: 20}}), title: faker.string.alpha({length: {min: 10, max: 20}}), purpose: faker.string.alpha({length: {min: 10, max: 20}}), collateral_type: faker.string.alpha({length: {min: 10, max: 20}}), interest_rate_bps: faker.number.int({min: undefined, max: undefined}), yield_bps: faker.number.int({min: undefined, max: undefined}), underlying_interest_rate_bps: faker.number.int({min: undefined, max: undefined}), term_months: faker.number.int({min: undefined, max: undefined}), remaining_term_days: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), risk_rating: faker.string.alpha({length: {min: 10, max: 20}}), funding_deadline: faker.helpers.arrayElement([faker.date.past().toISOString().split('T')[0], null]), maturity_date: faker.helpers.arrayElement([faker.date.past().toISOString().split('T')[0], null]), status: faker.string.alpha({length: {min: 10, max: 20}}), loan_status: faker.string.alpha({length: {min: 10, max: 20}}), opportunity_status: faker.string.alpha({length: {min: 10, max: 20}}), currency: faker.string.alpha({length: {min: 10, max: 20}}), principal_minor: faker.number.int({min: undefined, max: undefined}), committed_principal_minor: faker.number.int({min: undefined, max: undefined}), remaining_capacity_minor: faker.number.int({min: undefined, max: undefined}), fillable_amount_minor: faker.number.int({min: undefined, max: undefined}), minimum_investment_minor: faker.number.int({min: undefined, max: undefined}), ltv_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), null]), is_refinancing: faker.datatype.boolean(), originator_id: faker.helpers.arrayElement([faker.string.uuid(), null]), originator_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), borrower_display_name: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), null]), skin_in_the_game_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), minimum_subscription_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), default_penalty_interest_bps: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), borrower_id: faker.helpers.arrayElement([faker.string.uuid(), null]), borrower_disclosure: {
        [faker.string.alphanumeric(5)]: {}
...
export const getV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateResponseMock = (overrideResponse: Partial< BorrowerRepaymentAdvancePreviewResponse > = {}): BorrowerRepaymentAdvancePreviewResponse => ({loan_id: faker.string.uuid(), currency: faker.string.alpha({length: {min: 10, max: 20}}), amount_minor: faker.number.int({min: undefined, max: undefined}), bank_date: faker.date.past().toISOString().split('T')[0], interest_accrual_start_date: faker.date.past().toISOString().split('T')[0], interest_accrual_end_date: faker.date.past().toISOString().split('T')[0], accrued_interest_days: faker.number.int({min: undefined, max: undefined}), scheduled_interest_due_minor: faker.number.int({min: undefined, max: undefined}), accrued_interest_minor: faker.number.int({min: undefined, max: undefined}), interest_applied_minor: faker.number.int({min: undefined, max: undefined}), principal_applied_minor: faker.number.int({min: undefined, max: undefined}), outstanding_principal_before_minor: faker.number.int({min: undefined, max: undefined}), outstanding_principal_after_minor: faker.number.int({min: undefined, max: undefined}), anchor_installment_number: faker.number.int({min: undefined, max: undefined}), old_schedule_rows: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({installment_number: faker.number.int({min: undefined, max: undefined}), due_date: faker.date.past().toISOString().split('T')[0], principal_minor: faker.number.int({min: undefined, max: undefined}), interest_minor: faker.number.int({min: undefined, max: undefined}), total_minor: faker.number.int({min: undefined, max: undefined})})), new_schedule_rows: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({installment_number: faker.number.int({min: undefined, max: undefined}), due_date: faker.date.past().toISOString().split('T')[0], principal_minor: faker.number.int({min: undefined, max: undefined}), interest_minor: faker.number.int({min: undefined, max: undefined}), total_minor: faker.number.int({min: undefined, max: undefined})})), ...overrideResponse})
...
export const getV1FxQuotePreviewRetrieveMockHandler = (overrideResponse?: FxQuotePreview | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<FxQuotePreview> | FxQuotePreview), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/fx/quote-preview/', async (info) => {await delay(1000);
...
export const getV1InvestorSmartInvestRetrieveMockHandler = (overrideResponse?: SmartInvestResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<SmartInvestResponse> | SmartInvestResponse), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/investor/smart-invest/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1InvestorSmartInvestRetrieveResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getV1InvestorSmartInvestUpdateMockHandler = (overrideResponse?: SmartInvestResponse | ((info: Parameters<Parameters<typeof http.put>[1]>[0]) => Promise<SmartInvestResponse> | SmartInvestResponse), options?: RequestHandlerOptions) => {
  return http.put('*/api/v1/investor/smart-invest/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1InvestorSmartInvestUpdateResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getV1InvestorSmartInvestDeactivateCreateMockHandler = (overrideResponse?: SmartInvestResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<SmartInvestResponse> | SmartInvestResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/investor/smart-invest/deactivate/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1InvestorSmartInvestDeactivateCreateResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getV1LoansAdminLoansOriginalScheduleListMockHandler = (overrideResponse?: OriginalLoanScheduleRow[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<OriginalLoanScheduleRow[]> | OriginalLoanScheduleRow[]), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/loans/admin/loans/:loanId/original-schedule/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1LoansAdminLoansOriginalScheduleListResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getMarketplacePrimaryOrdersBatchCreateMockHandler = (overrideResponse?: PrimaryOrderBatchResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<PrimaryOrderBatchResponse> | PrimaryOrderBatchResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/marketplace/primary/orders/batch/', async (info) => {await delay(1000);
...
export const getV1MarketplaceSecondaryAdminListingsListMockHandler = (overrideResponse?: AdminSecondaryMarketListingRow[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<AdminSecondaryMarketListingRow[]> | AdminSecondaryMarketListingRow[]), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/marketplace/secondary/admin/listings/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1MarketplaceSecondaryAdminListingsListResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getV1MarketplaceSecondaryListingsRetrieveMockHandler = (overrideResponse?: SecondaryMarketBuyerListingDetail | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<SecondaryMarketBuyerListingDetail> | SecondaryMarketBuyerListingDetail), options?: RequestHandlerOptions) => {
  return http.get('*/api/v1/marketplace/secondary/listings/:listingId/', async (info) => {await delay(1000);
...
export const getV1MarketplaceSecondaryListingsEditCreateMockHandler = (overrideResponse?: SecondaryMarketListing | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<SecondaryMarketListing> | SecondaryMarketListing), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/marketplace/secondary/listings/:listingId/edit/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1MarketplaceSecondaryListingsEditCreateResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateMockHandler = (overrideResponse?: BorrowerRepaymentAdvancePreviewResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<BorrowerRepaymentAdvancePreviewResponse> | BorrowerRepaymentAdvancePreviewResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/v1/servicing/admin/borrower-repayments/advance-preview/', async (info) => {await delay(1000);

    return new HttpResponse(JSON.stringify(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getV1ServicingAdminBorrowerRepaymentsAdvancePreviewCreateResponseMock()),
      { status: 200,
        headers: { 'Content-Type': 'application/json' }
      })
  }, options)
...
export const getBanxumApiMock = () => [
  ...
  getV1FxQuotePreviewRetrieveMockHandler(),
  ...
  getV1InvestorSmartInvestRetrieveMockHandler(),
  getV1InvestorSmartInvestUpdateMockHandler(),
  getV1InvestorSmartInvestDeactivateCreateMockHandler(),
  ...
  getV1LoansAdminLoansOriginalScheduleListMockHandler(),
  ...
  getV1MarketplaceSecondaryAdminListingsListMockHandler(),
  ...
  getV1MarketplaceSecondaryListingsRetrieveMockHandler(),
